...
<?php
    ...
    <form action="adress_check.php" method="post">
        郵便番号 <input type="text" name="user_post" value="<?= htmlspecialchars($post) ?>"><br>
        都道府県
        <select name="user_pref">
            ...
            $prefectures = [
                ...
                "埼玉県", "千葉県", "東京都", "神奈川県", "山梨県", "長野県", "新潟県", "富山県", "石川県", "福井県",
        ...
        市区町村 <input type="text" name="user_city" value="<?= htmlspecialchars($city) ?>"><br>
        番地 <input type="text" name="user_address" value="<?= htmlspecialchars($address) ?>"><br>
        マンション名 <input type="text" name="user_building" value="<?= htmlspecialchars($building) ?>"><br>
        電話番号 <input type="text" name="user_phone" value="<?= htmlspecialchars($phone) ?>"><br>
