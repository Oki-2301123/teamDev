...
<!DOCTYPE html>
<html lang=<meta charset name="viewport" content="width=device-width, initial-scale=1.0">
<title>カート</title>
...
<body>
    ...
    echo '<input type="hidden" name="overallTotal" value="' . $overallTotal . '">'; // 合計金額を渡す
    echo '<input type="submit" name="proceed_to_checkout" value="レジへ進む">';
    echo '</form>';
    echo '<h3>カートが空です</h3>';
