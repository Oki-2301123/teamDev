...
<body>
    ...
    <form action="create_account_check.php" method="post">
        ...
        <input type="text" name="user_name1" placeholder="山田" required style="width: 180px; height: 30px;"> <input type="text" name="user_name2" placeholder="太郎" required style="width: 180px; height: 30px;"><br><br></div>
        <div class="title2"><span class="asterisk">＊</span>フリガナ
        <input type="text" name="user_ruby1" placeholder="ヤマダ" required style="width: 180px; height: 30px;"> <input type="text" name="user_ruby2" placeholder="タロウ" required style="width: 180px; height: 30px;"><br><br></div>
        ...
        <div class="aaaa"><input type="submit" value="確認画面へ進む  >" class="buttun2"></div>
        <br><br>
    </form>
    <!-- 野村 -->
</body>
