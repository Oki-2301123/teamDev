...
<body>
    ...
    <form action="create_account_check.php" method="post">
        ...
        <input type="text" name="user_bd" placeholder="2024" required style="width: 100px; height: 30px;"> 年　<input type="text" name="user_bd1" placeholder="01" required style="width: 40px; height: 30px;"> 月　<input type="text" name="user_bd2" placeholder="01" required style="width: 40px; height: 30px;"> 日　<br><br></div>
